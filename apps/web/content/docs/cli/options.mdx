...
Git hooks manager to use:

- `lefthook`: Fast and powerful Git hooks manager
- `husky`: Modern native Git hooks made easy
- `none`: No Git hooks manager (default)

```bash
create-better-t-stack --git-hooks lefthook
create-better-t-stack --git-hooks husky
create-better-t-stack --git-hooks none
```
...
```bash
create-better-t-stack --addons pwa biome
```
